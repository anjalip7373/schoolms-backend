...
// router.get('/teacher-subjects', authenticateToken, marksController.getTeacherSubjects);
// router.post('/teacher-subjects', authenticateToken, marksController.assignTeacherSubject);
// router.delete('/teacher-subjects/:id', authenticateToken, marksController.removeTeacherSubject);
